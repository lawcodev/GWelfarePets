...
import { PetAdd } from './action/petAction'
...
class AddNewPet extends Component {
  ...
  async handleNewPet (e) {
    ...
    if (!newPet.genre || newPet.name === '') {
      ...
      await this.props.PetAdd(newPet) // await, debido a que es asíncrono, se va a tardar algo en procesar.
...
export default connect(null, { PetAdd })(AddNewPet);
